      ...
      <el-row class="inline-info">
        <el-col :span="10">
          <el-form-item label="工号">
            <el-input v-model="userInfo.workNumber" style="width: 80%" class="inputW" />
          </el-form-item>
        </el-col>
        <el-col :span="10">
      ...
      <el-row class="inline-info">
        <el-col :span="10">
          <el-form-item label="姓名">
            <el-input v-model="userInfo.username" style="width: 80%" class="inputW" />
          </el-form-item>
        </el-col>
        <el-col :span="10">
          <el-form-item label="部门">
            <el-input v-model="userInfo.departmentName" style="width: 80%" class="inputW" />
          </el-form-item>
        </el-col>
      </el-row>
      <!--手机 聘用形式  -->
      <el-row class="inline-info">
        <el-col :span="10">
          <el-form-item label="手机">
            <el-input v-model="userInfo.mobile" style="width: 80%" disabled />
          </el-form-item>
        </el-col>
        <el-col :span="10">
          <el-form-item label="聘用形式">
            <el-select v-model="userInfo.formOfEmployment" style="width: 80%" class="inputW">
              <el-option
...
export default {
  ...
  methods: {
    ...
    // 3. 获取员工的基础信息 staffPhoto
    async getPersonalDetail() {
      this.formData = await getPersonalDetail(this.userId)
      if (this.formData.staffPhoto) {
        this.$refs.myStaffPhoto.fileList = [{ url: this.formData.staffPhoto.substring(5), upload: true }]
        console.log(this.formData.staffPhoto)
        console.log(this.$refs.myStaffPhoto.fileList)
      }
    },
    // 4. 保存员工的基础信息
    async savePersonal() {
